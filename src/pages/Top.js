...
export default function Top({
    invoicenumber, setInvoiceNumber, date, setDate, setBusinessname, businessname, clientAddress, setClientAddress, uen, setUen, mobilenumber, setMobilenumber, buyerordernumber, setBuyerordernumber, dated, setDated, paymentterms, setPaymentterms
            ...
            <form>
                <div className="row">
                    <div className="col-md-6 col-lg-6 col-sm-12">
                        ...
                        <div className="row">
                            <div className="col-md-4 col-lg-4 col-sm-12">
                                <label htmlFor="uennumber">GST</label>
                            </div>
                            <div className="col-md-8 col-lg-8 col-sm-12">
                                <div className="form-group mb-2">

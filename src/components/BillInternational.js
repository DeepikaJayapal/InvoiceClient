...
import TopInternational from '../pages/TopInternational';
...
export default function BillInternational() {
                    ...
                    <div className='bodering'>
                        ...
                        <div className="d-flex">
                            ...
                            <div >
                                ...
                                <div style={{ fontSize: "17px" }}>LUT :  {lut}</div>
                            </div>
                        </div>
                        ...
                        <form>
                            <div className="d-flex " style={{ height: "18%" }}>
                                <div style={{ width: "53%" }}>
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <label htmlFor="uennumber">UEN : </label> {uen}
                                        </div>
                                    </div>

                                    <div className="row">
                                        <div className="col">
                                            <label htmlFor="Mobile-Number">Contact Number : </label> {mobilenumber}
                                        </div>
                                    </div>
                                </div>
                                <div>

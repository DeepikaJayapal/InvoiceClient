...
export default function Table({
    ...
    const handleSubmit = (e) => {
        ...
        if (!productname || !quantity || !hsncode || !price || !igsts) {
        ...
        <div>
            <div className="row">
                <div className="col-md-12 col-lg-12 col-sm-12">
                    <div className="table-responsive top">
                        <table className="table" id="tableid">
                            ...
                            <tbody style={{ color: "black" }}>
                                {lists.map(({ id, productname, hsncode, quantity, price, amount, igsts, igsttotal }) => (
                    ...
                    <form onSubmit={handleSubmit} className="d-flex">
                        ...
                        <button type="submit" style={{ border: "none", fontWeight: "bold", marginLeft: "15px" }} className="rounded">{isEditing ? "Edit Item" : "Add Item"}</button>
            ...
            <div className="row py-2" style={{ textAlign: "right", paddingRight: "80px", marginBottom: "0px" }}>
                ...
                <div className="col-md-8 col-lg-8 col-sm-12 py-2">
                    <input type="text" className="form-control input-sm" name="amountinwords" value={amountinwords} placeholder='Amount in words' style={{fontWeight: "bold"}} />
                </div>
            </div>
        </div>
    )
